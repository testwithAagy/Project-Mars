...
public class Hooks
{
    ...
    public static void BeforeTestRun()
    {
        ...
        string reportPath = Path.Combine(projectRoot, _settings.Report.Path.TrimStart('/'));
    ...
    public void BeforeScenario(ScenarioContext scenarioContext)
    {
        ...
        if (_settings.Browser.Headless) chromeOptions.AddArgument("--headless");
    ...
    public void AfterStep(ScenarioContext scenarioContext)
    {
        ...
        lock (_reportLock)
        {
            ...
            {
                _test!.Log(AventStack.ExtentReports.Status.Pass, $"{stepType} {stepText}");
            }
            else
            {
                ...
                _test!.Log(AventStack.ExtentReports.Status.Fail, $"{stepType} {stepText}",
    ...
    public void AfterScenario(ScenarioContext scenarioContext)
    {
        ...
        Console.WriteLine($"Finished scenario {scenarioContext.ScenarioInfo.Title} at {DateTime.Now}");
    }
